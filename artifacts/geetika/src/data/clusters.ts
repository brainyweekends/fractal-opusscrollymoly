...
export const CLUSTERS: Cluster[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      topic("Early Medals", "More proof from the early years.", "Another row-wide set of keepsakes from childhood — medals, ribbons, and little wins that belong in the same visual lane as the trophies."),
    ],
  },
  {
